...
printf("\t12- afficher le plus court chemin \n");
printf("\t0- fermer \n");
...
case 12:
	system("cls");
	printf("\tentrez les lettre representant le sommet de depart et le sommet d'arrive 'u' et 'v'\n\tu:\t");
	getchar();
	scanf("%c",&u);
	printf("\n\n\tv:\t");
	getchar();
	...
	getchar();
	Matrice=matriceadjacence(G);
	djikstra(G,Matrice,indice(G,u),indice(G,v));
	printf("\n\n\t");
	system("pause");
	goto menu;
break;
